 ...
 */
public class MasterMBeanServerInterceptor implements MyMBeanServerInterceptor {
     ...
     */
    protected final MBeanServer defaultInterceptor() {
     ...
     */
    protected final MBeanServer otherInterceptor() {
