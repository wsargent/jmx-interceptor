...
public class FileMBeanServerInterceptor implements MBeanServerInterceptor {
     ...
     * <var>file</var>.
     * @throws MalformedObjectNameException if the ObjectName cannot
     *                                      be constructed (e.g. the <i>CanonicalPathname</i> contains
     *                                      illegal characters such as `,' or `=' etc...).
     * @throws IOException                  if the <i>CanonicalPathname</i> cannot be
     ...
     *             be derived.
     * @throws InstanceNotFoundException if the given name does not
     ...
     * @throws IOException if we can't change to the given directory.
     */
     ...
     *                will mirror.
     * @throws IllegalArgumentException if the given directory can't
     *                                  be mirrored.
     */
